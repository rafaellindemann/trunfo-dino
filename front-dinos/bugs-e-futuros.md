# bugs já encontrados no meu front
- após a primeira rodada, spamar enter ou espaço tá fazendo vencer tudo;
-- ao final de uma mão, a carta troca antes de virar;
-- as imagens oficiais podem estar maiores que o container (rex tá, trike não parece)
- o modal de resultado está atrapalhando conferir o resultado. É melhor ele ficar entre as cartas e não sobre. Resolvido, mas ainda pode ser mais largo, ou talvez ser todo o espaço entre as cartas. 
- unificar versão server/local com checkbox na criação.
- tooltip do dino clicando no nome dele
